...
export default function Header() {
  ...
  return (
    <header
      className="sticky top-0 left-0 right-0 z-50 bg-brand-slate shadow-xl py-4 transition-all duration-300"
    >
          ...
          <div className="hidden lg:flex items-center gap-6">
            <div className="flex flex-col items-end">
              ...
              <div className="flex items-center gap-2 text-white/70 text-xs font-bold uppercase tracking-tighter">
                ...
                <span>Plattsburgh, NY 12901</span>
              </div>
            </div>
            <button 
              onClick={() => setIsFormOpen(true)}
              className="bg-brand-orange hover:bg-orange-600 text-white font-black px-6 py-3 text-sm uppercase tracking-widest transition-all transform hover:scale-105 active:scale-95 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)]"
            >
              Request a Quote
            </button>
          </div>
          ...
          >
            <div className="px-4 py-6 space-y-4">
              ...
              <button 
                ...
                className="w-full bg-brand-orange text-white font-black py-4 text-center uppercase tracking-widest mt-4"
              >
                Request a Quote
              </button>
            </div>
