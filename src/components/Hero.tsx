      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="flex items-center justify-center gap-3 bg-brand-orange hover:bg-orange-600 text-white font-black px-8 py-5 text-base uppercase tracking-widest transition-all group">
              Start a Quote
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="flex items-center justify-center gap-3 bg-white/10 hover:bg-white/20 text-white font-black px-8 py-5 text-base uppercase tracking-widest transition-all backdrop-blur-sm border border-white/20 group">
